...
function CreateEvent () {
    ...
    const handleImageUpload = (e) => {
        ...
        if (file) { // Check if a file is selected
            ...
            reader.onloadend = () => {
                setEvent(prevEvent => ({
                    ...prevEvent,
                    eventimage: reader.result.split(',')[1] // Get base64 string
                }));
            };
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost/Project1/webProject/backend/routers/EventApi.php?action=register', event)
            .then(response => {
    ...
    return(
        <div className="container-fluid p-5 col-12 col-md-8 my-5"  style={{border:'1px solid #CFBD97'}}>
            <h1 className="text-center text-secondary"><span style={{color:'#CFBD97'}}>Ajouter </span>Un <span style={{color:'#CFBD97'}}>Evenement</span></h1>
            <div className="container-fluid">
                <form className="mt-5" onSubmit={handleSubmit}>
                    <label className="form-label mt-3 text-secondary">Nom du Evenements</label>
                    ...
                    <input className="form-control mt-3"
                        ...
                        onChange={handleChange}
                        required/>
                    <label className="form-label mt-3 text-secondary">Date</label>
                    <input className="form-control mt-3"
                        type="text"
                        name="eventdate"
