...
function GerantSignIn () {
    ...
    const handleLogin = (e) => {
        ...
        axios.post('http://localhost/Project1/webProject/backend/routers/GerantApi.php?action=login', {id, password})
            .then(response =>{
    ...
    return (
        <div className="container-fluid bg-black">
            <div className="container col-12 col-md-6 px-5" style={contstyle}>
                <p className="fs-1 fw-bold mt-5 mb-3 text-center">Gérant Login</p>
                <form className="mt-5 text-center" onSubmit={handleLogin}>
                    <input value={id} onChange={(e) => setId(e.target.value)} className="form-control mt-3" type="text" placeholder="Entrez votre ID Gérant" required/>
                    <label className="form-label mt-5 fw-bold">Code Secret Gérant</label>
